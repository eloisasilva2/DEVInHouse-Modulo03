...
public class ProgramaComTeste {
    public static void main(String[] args) {
        ...
        double maiorLanceEncontrado = leiloeiro.
                getMaiorLance();
        double menorLanceEncontrado = leiloeiro.
                getMenorLance();
        System.out.println(maiorLanceEncontrado ==
                maiorLanceEsperado);
        System.out.println(menorLanceEncontrado == 200);
